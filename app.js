...
import { CampusMapManager, BUILDINGS_DATA } from './components/map.js?v=16';
import { NotificationManager } from './components/alerts.js?v=16';
import { ScheduleManager } from './components/schedule.js?v=16';
