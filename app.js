...
import { CampusMapManager, BUILDINGS_DATA } from './components/map_v2.js?v=19';
import { NotificationManager } from './components/alerts.js?v=19';
import { ScheduleManager } from './components/schedule.js?v=19';
